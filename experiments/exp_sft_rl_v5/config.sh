...
export PAIR_MAX_PER_PROMPT=15000
export PAIR_GAP=0.1
...
# (3 targets x ~150 filtered pairs each in this setup).
export DPO_TOTAL_PAIRS=450

# --- Composite Reward (Plan B) ---
# Normalized weights: proxy is primary (85%), others regularize (5% each)
export REWARD_W_PROXY=0.85
export REWARD_W_GEOM=0.05
export REWARD_W_COMP=0.05
...
export EHULL_THRESHOLD=999        # Use all composition-matching structures

# --- DPO (Stage 2) ---
export DPO_STEPS=6000
export DPO_BETA=1.0
export DPO_LR=2e-6
